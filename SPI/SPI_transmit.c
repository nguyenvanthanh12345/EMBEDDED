...
#define SCK(status) HAL_GPIO_WritePin(GPIOA,GPIO_PIN_0,status)
#define MOSI(status) HAL_GPIO_WritePin(GPIOA,GPIO_PIN_1,status)
#define MISO HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_2)
#define SS(status) HAL_GPIO_WritePin(GPIOA,GPIO_PIN_3,status)
